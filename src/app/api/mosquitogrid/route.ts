...
// Атырау қаласының аудандары мен нақты көшелері — жеке сағаттық индекс
const ATYRAU_DISTRICTS: { lat: number; lng: number; name: string }[] = [
  ...
  // Жайық өзені жағасы — маса тәуекелі жоғары
  { lat: 47.122,  lng: 51.873,  name: "Жайық жағасы (сол)" },
  { lat: 47.108,  lng: 51.877,  name: "Жайық жағасы (оң)" },
  { lat: 47.135,  lng: 51.882,  name: "Көпір маңы" },
  { lat: 47.095,  lng: 51.895,  name: "Өзен дельтасы" },
  // Солтүстік аудандар
  { lat: 47.168,  lng: 51.875,  name: "Солтүстік-1" },
  { lat: 47.175,  lng: 51.900,  name: "Солтүстік-2" },
  { lat: 47.162,  lng: 51.855,  name: "Жаңа қала" },
  { lat: 47.180,  lng: 51.855,  name: "Нұрқала" },
  // Оңтүстік аудандар
  { lat: 47.062,  lng: 51.875,  name: "Оңтүстік-1" },
  { lat: 47.055,  lng: 51.900,  name: "Оңтүстік-2" },
  { lat: 47.068,  lng: 51.850,  name: "Теміржол маңы" },
  // Шығыс аудандар
  { lat: 47.118,  lng: 51.945,  name: "Шығыс-1" },
  { lat: 47.102,  lng: 51.960,  name: "Шығыс-2" },
  { lat: 47.140,  lng: 51.952,  name: "Достық" },
  // Батыс аудандар
  { lat: 47.120,  lng: 51.820,  name: "Батыс-1" },
  { lat: 47.105,  lng: 51.808,  name: "МӨЗ маңы" },
  { lat: 47.138,  lng: 51.830,  name: "Батыс-2" },
  // Маңызды көшелер / аймақтар
  { lat: 47.113,  lng: 51.886,  name: "Әзіз Мамбетов к." },
  { lat: 47.125,  lng: 51.896,  name: "Сатпаев к." },
  { lat: 47.117,  lng: 51.910,  name: "Абай даңғылы" },
  { lat: 47.130,  lng: 51.870,  name: "Махамбет к." },
  { lat: 47.098,  lng: 51.868,  name: "Молдағали к." },
  { lat: 47.143,  lng: 51.905,  name: "Студенттік аудан" },
  { lat: 47.082,  lng: 51.910,  name: "Жаңа нұр" },
  { lat: 47.157,  lng: 51.935,  name: "Алтын орда" },
];
