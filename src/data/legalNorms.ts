...
export const ACTS: Record<string, LegalAct> = {
  kzAir: {
    ...
    url: "https://adilet.zan.kz/kaz/docs/V2200029011",
    note:
      "Нормативтік құқықтық актілерді мемлекеттік тіркеу тізілімінде № 29011 болып тіркелген. " +
      "Кейінгі өзгерістер: 2023 ж. № 60 және 2025 ж. 18 ақпандағы № 10 бұйрықтар " +
      "(тіркеу № 35741). 2015 жылғы № 168 бұйрық КҮШІН ЖОЙҒАН — ескі норманы қолдануға болмайды.",
  },
  kzAir2025: {
    id: "kzAir2025",
    jurisdiction: "KZ",
    title:
      "«Қалалық және ауылдық елді мекендердегі, өнеркәсіптік ұйымдар аумақтарындағы " +
      "атмосфералық ауаның гигиеналық нормативтерін бекіту туралы» бұйрыққа өзгерістер",
    number: "№ 10 (тіркеу № 35741)",
    date: "2025-02-18",
    authority: "ҚР Денсаулық сақтау министрі",
    url: "https://adilet.zan.kz/kaz/docs/V2500035741",
    note:
      "ҚР ДСМ-70 бұйрығының қолданыстағы редакциясын осы өзгеріспен бірге оқу керек. " +
      "⚠️ ШРК кестесі осы жүйеде әлі толық расталмаған — актіні ашып салыстыру қажет.",
  },
  kzEcoCode: {
    id: "kzEcoCode",
    jurisdiction: "KZ",
...
export const NORMS: LegalNorm[] = [
  ...
  // ---------- CO ----------
  // ⚠️ БІРЛІК: мұнда БАРЛЫҚ шек µg/m³-пен жазылады, себебі CAMS деректері
  // сол бірлікте келеді әрі салыстыру қозғалтқышы шикі санды салыстырады.
  // Құқықтық актілерде CO жиі мг/м³-пен беріледі: 1 мг/м³ = 1000 µg/m³.
  // Айналдыруды осында, БІР ЖЕРДЕ жасаймыз — есептеу тізбегінде емес.
  {
    indicatorId: "co",
    actId: "who2021",
    averaging: "daily",
    ...
    unit: "µg/m³",
    status: "verified",
    statusNote: "WHO 2021 нұсқаулығы: тәуліктік 4 мг/м³ = 4000 µg/m³",
  },
  {
    indicatorId: "co",
    actId: "kzAir",
    ...
    status: "needs-primary-check",
    statusNote:
      "5 мг/м³ (максималды бір реттік) деп кең таралған әрі ондаған жыл " +
      "өзгермеген; ҚР ДСМ-70 мәтінінен расталуы керек. Расталмағандықтан " +
      "бұл шек бойынша «заң бұзылды» деген тұжырым ШЫҒАРЫЛМАЙДЫ.",
  },
  {
    indicatorId: "co",
    actId: "kzAir",
    ...
    status: "needs-primary-check",
    statusNote:
      "3 мг/м³ (орташа тәуліктік) деп кең таралған; ҚР ДСМ-70 мәтінінен " +
      "расталуы керек. Расталғанша тек алдын ала белгі.",
  },
];
