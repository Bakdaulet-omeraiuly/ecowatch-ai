...
export const INDICATORS: Indicator[] = [
  ...
  },
  {
    ...
    limits: [
      ...
      "Атырауда шаң дауылы кезінде модель нақты шыңды жеткізбеуі мүмкін",
    ],
    validated: false,
  ...
  },
  {
    ...
    steps: [
      ...
      "Атырау үшін шөл шаңының үлесі маңызды — ол бөлек компонент",
    ],
    instrument: "Copernicus CAMS",
    spatial: "≈40 км тор",
    temporal: "сағат сайын",
  ...
  },
  {
    ...
    digits: 1,
    what:
      "Жану процестерінің көрсеткіші — көлік, ЖЭО, мұнай өңдеу. Атырауда " +
      "өнеркәсіптік шығарындының негізгі маркері.",
  ...
  },
  {
    ...
    digits: 1,
    what:
      "Күкіртті отынның жануы мен мұнай өңдеудің көрсеткіші. Атыраудағы " +
      "мұнай-газ инфрақұрылымына тікелей қатысты.",
  ...
  // ======================= ӨРТ ЖӘНЕ ЖЫЛУ =======================
  {
    ...
    spatial: "нүктелік (Атырау қаласы)",
    temporal: "тәулік сайын",
    latency: "≈6 сағат",
  ...
  },
  {
    ...
    path: "flares.length",
    what:
      "Спутник инфрақызыл арнада тіркеген жылу нүктелері. Атырауда бұл — " +
      "газ факелдері немесе дала өрттері.",
    ...
    steps: [
      ...
      "Атырау облысы шекарасына сүзгіленеді",
    ],
  ...
  // ======================= БИОҚАУІП =======================
  {
    ...
    formula: "MRI = 100 · T(темп) · W(су режимі) · H(ылғал)",
    steps: [
      "T — Mordecai 2017 термиялық қолайлылық қисығы (біркелкі емес, оптимум бар)",
      "W — су режимі: Aedes caspius үшін тасқын импульсі, Culex modestus үшін тұрақты су",
      "H — салыстырмалы ылғалдылық көбейткіші",
      "Айға байланысты жұмыртқа банкі мен түрлердің үлесі өзгереді (FPEB тәсілі)",
      "Көбейткіштер туындысы 0–100 шкаласына келтіріледі",
    ],
    instrument: "Open-Meteo метеорологиясы бойынша есептелген жеке модель",
    spatial: "тор нүктелері (облыс бойынша)",
    temporal: "сағат сайын",
    latency: "≈1 сағат",
    sources: [DOC.openMeteoWx],
    references: [DOC.mordecai],
    limits: [
    ...
    validated: false,
    validationNote:
      "Атырауда тұзақ (trap) деректері жинақталмағандықтан валидациялау мүмкін емес",
  },
