...
export const INDICATORS: Indicator[] = [
...

  {
    id: "co",
    section: "Ауа сапасы",
    name: "CO — көміртек оксиді (иіс газы)",
    unit: "µg/m³",
    tier: "model",
    endpoint: "/api/environment",
    path: "current.co",
    digits: 0,
    what:
      "Отынның ТОЛЫҚ ЖАНБАУЫНЫҢ маркері. Түссіз әрі иіссіз, сондықтан " +
      "адам оны сезбейді. Гемоглобинмен байланысып, қанның оттегі " +
      "тасымалдау қабілетін төмендетеді.",
    formula: "C(CO) — CAMS модель тордағы жер бетіне жақын қабаттың концентрациясы",
    steps: [
      "CAMS жанудан шығатын CO шығарындысын есептейді (көлік, қазандық, факел, дала өрті)",
      "Атмосферадағы тотығуы (CO → CO₂) ескеріледі",
      "Нәтиже жер бетіне жақын қабат үшін беріледі",
    ],
    instrument: "Copernicus CAMS",
    spatial: "≈40 км тор",
    temporal: "сағат сайын",
    ...
    norms: [
      {
        label: "ДДҰ 2021 — тәуліктік нұсқаулық (4 мг/м³)",
        value: 4000,
        comparison: "max",
        source: DOC.who2021,
      },
    ...
    limits: [
      "Модель мәні — станция өлшемі емес",
      "40 км тор жол бойындағы жергілікті шыңды көрсетпейді, ал CO дәл сонда жоғары болады",
      "⚠️ Бірлік — µg/m³. Норма құжаттарында CO жиі мг/м³-пен беріледі: 1 мг/м³ = 1000 µg/m³",
    ],
    validated: false,
    validationNote: "Жергілікті станциямен салыстыру жүргізілмеген",
  },
  ...
  // ======================= БИОҚАУІП =======================
  {
    ...
    steps: [
      ...
      "Aedes тармағы ДИНАМИКАЛЫҚ: dE/dt, dL/dt, dA/dt теңдеулері тәуліктік қадаммен интегралданады (GloFAS күндік тасқыны драйвер). Су басу → жұмыртқа жарылады → дернәсіл τ(T) күн дамиды → ересек шығады. Сондықтан индекс шыңы тасқынмен бір күні емес, одан КЕЙІН болады",
      "Күй дерекқорда сақталмайды: әр сұраныста 30 күндік «жүгіріспен» нөлден қайта интегралданады (FWI-мен бірдей тәсіл) — нәтиже детерминистік",
      "Нормалау: идеал жағдайдағы (су толық, T = 25.9 °C) модельдің өз тұрақты шыңына қатысты үлес",
    ...
    limits: [
      ...
      "ODE параметрлері (μ_дернәсіл 0.10, μ_ересек 0.12, жарылу коэф. 0.6, 150 градус-күн) — әдебиеттегі кулициндік шамалар, Aedes caspius үшін калибрленбеген",
      "GloFAS күндік қатары қолжетімсіз болса динамика жүрмейді — модель лездік жуықтауға шегінеді, ол жауапта белгіленеді",
