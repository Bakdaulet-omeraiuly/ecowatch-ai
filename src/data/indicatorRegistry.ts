...
export const INDICATORS: Indicator[] = [
  ...
  // ======================= БИОҚАУІП =======================
  {
    ...
    steps: [
      "Φ_T — температура гейті: Mordecai 2017 тәсіліне негізделген бір шыңды қисық (15–36 °C, шыңы ~28 °C). ⚠️ Мақаладағы Brière функциясы емес, жеңілдетілген квадрат түрі",
      ...
      "Culex тармағы: тұрақты су (импульс + қала дренажы) × ылғалдылық",
      "Айлық динамикалық салмақ: көктемде Aedes (тасқын), жаз ортасында Culex (WNV)",
    ],
    instrument:
      "Жеке модель. Кірістер: Open-Meteo (ECMWF) метеорологиясы + Copernicus Sentinel-1 SAR + GloFAS",
    ...
    limits: [
      ...
      "Гидропериод (су неше күн тұрды) әлі өлшенбейді — топырақ ылғалы прокси ретінде қолданылады",
    ],
    validated: false,
    validationNote:
