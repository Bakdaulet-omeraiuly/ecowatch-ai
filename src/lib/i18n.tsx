...
const DICT = {
  kk: {
    ...
    "hero.badge": "Қазақстан және Каспий жағалауы · экологиялық мониторинг",
    "hero.sub": "Спутник · Заңнама · Ашық дерек",
    "hero.desc": "Спутник өлшемдері мен ресми атмосфералық модельдер негізінде ауа, су, топырақ пен өрт жағдайын бақылаймыз. Әр көрсеткіш заңнамалық нормамен салыстырылады, ал деректің қайдан келгені әрқашан ашық көрсетіледі.",
  ...
  ru: {
    ...
    "hero.badge": "Казахстан и побережье Каспия · экологический мониторинг",
    "hero.sub": "Спутник · Законодательство · Открытые данные",
    "hero.desc": "Отслеживаем состояние воздуха, воды, почвы и пожарной опасности по спутниковым измерениям и официальным атмосферным моделям. Каждый показатель сверяется с нормативом, а происхождение данных всегда указано.",
  ...
  en: {
    ...
    "hero.badge": "Kazakhstan & the Caspian coast · environmental monitoring",
