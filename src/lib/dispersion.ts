 ...
 *
 * Физикалық бұрыш түнгі орнықты қабатта (F класы) 3°-тан төмен түседі:
 * 30 км-де 2,3°. Ондай конус экранда жіп сияқты болып, көрінбей қалады.
 * Сондықтан СЫЗБА кемінде осы бұрышпен салынады, ал панельде НАҚТЫ сан
 * жазылады — есептеу де нақты бұрышпен жүреді.
 */
export const MIN_VISUAL_HALF_ANGLE = 3;
